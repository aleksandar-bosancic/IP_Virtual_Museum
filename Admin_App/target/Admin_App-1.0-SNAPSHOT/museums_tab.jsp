...
<div class="tab-pane fade" id="museums_panel" role="tabpanel" aria-labelledby="museums-tab">
    <a class="btn btn-primary" href="museum_pages/add_museum.jsp" style="margin-top: 2vh">Add museum</a>
    <table class="table" id="museums_table" style="margin-top: 3vh">
        ...
        <tr>
            ...
            <td><%=bean.getType()%></td>
            <td>
                <a class="btn btn-primary" href="museums_tab/update_museum.jsp?id=<%=bean.getId()%>">
            ...
            <td>
                <a class="btn btn-primary" href="museums_tab/delete_museum.jsp?id=<%=bean.getId()%>">
